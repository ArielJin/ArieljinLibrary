 ...
 */
public final class ColorSizeTrackView extends View {
...
//    private int mTrackTextSize = getResources().getDimensionPixelSize(R.dimen.ariel_text_size_4);
    ...
    public ColorSizeTrackView(Context context) {
        this(context, null);
    }

    public ColorSizeTrackView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ColorSizeTrackView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);

        TypedArray ta = context.obtainStyledAttributes(attrs,
                R.styleable.ColorSizeTrackView);
        mText = ta.getString(R.styleable.ColorSizeTrackView_cstvText);
        mTextSize = ta.getDimensionPixelSize(
                R.styleable.ColorSizeTrackView_cstvText_size, mTextSize);
        mTextOriginColor = ta.getColor(
                R.styleable.ColorSizeTrackView_cstvText_origin_color, mTextOriginColor);
        mTextChangeColor = ta.getColor(
                R.styleable.ColorSizeTrackView_cstvText_change_color, mTextChangeColor);
        mProgress = ta.getFloat(R.styleable.ColorSizeTrackView_cstvProgress, 0);

        mDirection = ta
                .getInt(R.styleable.ColorSizeTrackView_cstvDirection, mDirection);
