 ...
 */
public abstract class AbsHeaderScrollingBehavior extends CoordinatorLayout.Behavior<RecyclerView> {
    ...
    public AbsHeaderScrollingBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean layoutDependsOn(CoordinatorLayout parent, RecyclerView child, View dependency) {
        if (dependency != null && dependency.getId() == getScrollingHeaderId()) {
...
//                Math.abs(dependency.getTranslationY() / (dependency.getHeight() - resources.getDimension(getCollapsedHeaderHeightDimension())));
//
...
//        super.onStopNestedScroll(coordinatorLayout, child, target);
    ...
    private float getDependentViewCollapsedHeight() {
        return getDependentView().getResources().getDimension(getCollapsedHeaderHeightDimension());
    }
    ...
    public abstract int getScrollingHeaderId();

    public abstract int getCollapsedHeaderHeightDimension();
}
