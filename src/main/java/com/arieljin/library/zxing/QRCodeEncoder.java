...
// */
//
//package com.arieljin.library.zxing;
//
...
//
//  QRCodeEncoder(/*Context activity, Intent intent, */String contents,int dimension/*, boolean useVCard*/,BarcodeFormat format) /*throws WriterException */{
