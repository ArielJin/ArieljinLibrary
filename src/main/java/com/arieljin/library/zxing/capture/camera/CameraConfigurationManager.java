...
import com.arieljin.library.zxing.capture.PreferencesKeys;
import com.arieljin.library.zxing.capture.camera.open.CameraFacing;
...
final class CameraConfigurationManager {
  ...
  void setDesiredCameraParameters(OpenCamera camera, boolean safeMode) {
    ...
    CameraConfigurationUtils.setFocus(
        ...
        prefs.getBoolean(PreferencesKeys.KEY_DISABLE_CONTINUOUS_FOCUS, true),
        safeMode);
