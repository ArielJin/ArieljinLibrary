...
//        screenAspectRatio分情况设置，因为screenAspectRatio的要求总是大值比小值
...
//删除如下代码，原因是对于镜头分辨率高，而屏幕分辨率低的手机，这段代码直接导致扫码插件采用较低的分辨率去生成用于解析的位图，所以直接去掉。然后你就会发现低分辨率的手机，对二维码、条码的识别率显著提高
